...
private:
	...
	const char* WindowTitle = "Vulkan Tutorial 08 : Generating Mipmaps";
	...
	void CreateDepthResources()
	{
		...
		CreateImage(width, height, 1, format, tiling, usage, properties, DepthImage, DepthImageMemory);
	...
	void CreateTextureImage()
	{
		...
		// VkMemoryPropertyFlags properties = VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT;
		CreateImage(width, height, MipLevels, format, tiling, usage, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, TextureImage, TextureImageMemory);
